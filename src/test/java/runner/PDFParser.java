	...
	public void generateStepDefinitions() {
		try {
			...
			if(operatingSystem.contains("win")) {
				System.out.println("Executing Command: " + "java -cp "+baseDirPath+"/AutoGeneratedGherkinScripts-jar-with-dependencies.jar org.junit.runner.JUnitCore runner.TestRunner");
				processBuilder.command("cmd.exe", "/c", "java -cp "+baseDirPath+"/AutoGeneratedGherkinScripts-jar-with-dependencies.jar org.junit.runner.JUnitCore runner.TestRunner");
			} else {
				System.out.println("Executing Command: " + "java -cp "+baseDirPath+"/AutoGeneratedGherkinScripts-jar-with-dependencies.jar org.junit.runner.JUnitCore runner.TestRunner");
				processBuilder.command("bash", "-c", "java -cp "+baseDirPath+"/AutoGeneratedGherkinScripts-jar-with-dependencies.jar org.junit.runner.JUnitCore runner.TestRunner");
			}
