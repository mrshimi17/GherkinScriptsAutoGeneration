	...
	public void generateStepDefinitions() {
		try {
			...
			if(operatingSystem.contains("win")) {
				processBuilder.command("cmd.exe", "/c", "java -cp "+baseDirPath+"/target/AutoGeneratedGherkinScripts-jar-with-dependencies.jar org.junit.runner.JUnitCore runner.TestRunner");
			} else {
